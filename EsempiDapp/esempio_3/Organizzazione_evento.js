...
const contract_address_Distributor = "0xBc4edbF706C5aE542f940bcFf49d184DA533622E";
...
async function getBalances() {
    try {
        ...
        if (myATM !== zero_address) {
            ...
            document.getElementById('atm-balance1').innerHTML = 'ATM inesistente';
            document.getElementById('atm-balance2').innerHTML = 'ATM inesistente';
        }
    } catch {
